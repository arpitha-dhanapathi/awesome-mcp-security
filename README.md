...
- [Pluto AgentGuard](https://github.com/arpitha-dhanapathi/pluto-aguard) - Security launch gate for AI agents: scans MCP configs for dangerous servers/secrets/misconfigs, tests policy coverage against 22 attack scenarios, simulates risk impact of policy changes, and generates OWASP-inspired control reports. Static-only, offline, no API keys. Validated against 1,200 real GitHub MCP configs.
